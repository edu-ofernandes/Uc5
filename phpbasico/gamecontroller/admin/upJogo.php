...
if(isset($_GET['idUp'])){
    ...
    // $listarIdCategoria = $dalCategoria->listarIdCategoria($row['categorias_id']);
    ...
    //     $jogo = new Jogo();
    //     $jogo->getNome(addslashes($_POST['txtNomeJogo']));
    //     $jogo->getFoto($foto);
    //     $jogo->getIdCategoria($_POST['selCategoria']);
                    ...
                    <div class="form-row ">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select name="selCategoria" id="selCategoria" class="form-control">
                                ...
                                <?php while($row2 = mysqli_fetch_array($listarIdCategoria)){?>
                                
                                <option value="<?php echo $row2['id'];?>"><?php echo $row['nome'];?></option>
