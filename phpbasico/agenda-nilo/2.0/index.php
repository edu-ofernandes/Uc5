...
<body>
    ...
    <main>
        ...
        <!-- loop termina -->
            ...
            <!-- loop 2 começa -->
            <?php }elseif( $_GET['id'] != "" && mysqli_num_rows($resultadoBuscaAlfa) != 0){  ?>
        ...
        <section class="todos-contatos lista-busca">
            ...
            <?php } elseif(mysqli_num_rows($resultadoBuscaAlfa) == 0) {    ?> 
                <h2>Nenhum resultado</h2>
            </section>
            <?php }?>

            <?php  if(isset($_GET['btSerach']) && mysqli_num_rows($resultadoBusca) != 0){  ?>
